...
H=model.fit_generator(train_generator, steps_per_epoch=batch_size,validation_data=test_generator, epochs=epochs,verbose=1,validation_steps=0.2) #train for randomly selected one
...
plt.savefig("D:/aa/plot_loss2.png")  
# Accuracy Curves
plt.figure(figsize=[8,6])
...
plt.savefig("D:/aa/plot_acc2.png")
#------------------------------
